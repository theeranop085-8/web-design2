...
<body>
    ...
    <section class="main">
            ...
            <div class="slider">
                <div class="slides">
                    ...
                    <div class="slide first">
                        <img src="img/bleach/1.bleach.jpg">
                    </div>
                    <div class="slide">
                        <img src="img/bleach/2.bleach.jpg">
                    </div>
                    <div class="slide">
                        <img src="img/bleach/3.bleach.jpg">
                    </div>
                    <div class="slide">
                        <img src="img/bleach/4.bleach.jpg">
                    </div>
                    <div class="slide">
                        <img src="img/bleach/5.bleach.jpg">
                    </div>
                </div>
        ...
        <div class="text-box">
            <article>
                ...
                <p> <pre>    Puyuan store – Bleach<b class="price"> : ราคา 6700 บาท มัดจำ 2000 บาท 
                    Deluxe ราคา 11800 บาท มัดจำ 3800 บาท  
                    Special ราคา 6600 บาท มัดจำ 2000 บาท</b>
                    
    
    Material : Resin/PU
    Size :  18cm (H) x 30cm (W) x 23cm (D)
   ...
   &#128293Shopee : https://shp.ee/g65u4vf &#128293
    ...
    <form action="product_detail.php?p_id=5" method="post">
